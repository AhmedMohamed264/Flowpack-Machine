...
/*
 * Note : Line start from 0 to 3
 * */
void CLCD_voidPosition(u8 Copy_u8Line,u8 Copy_u8Position)
{
	u8 Local_u8Address = 0x00;

	if(Copy_u8Line == 0)
	{
		Local_u8Address = Copy_u8Position;
	}
	else if(Copy_u8Line == 1)
	{
		Local_u8Address = Copy_u8Position + 0x40;
	}
	else if(Copy_u8Line == 2)
	{
		Local_u8Address = Copy_u8Position + 0x14;
	}
	else if(Copy_u8Line == 3)
	{
		Local_u8Address = Copy_u8Position + 0x54;
	}
